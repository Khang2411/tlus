...
import { ChangeEvent, createContext, FormEvent, Fragment, useEffect, useRef, useState } from "react"
...
export default function AdmissionsRegister(this: any) {
    ...
    const [state, setState] = useState({
        surname: "", name: "", birthday: "", cccd: data.cccd, gender: "", phone: "",
...
// Check login
    ...
    const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
        ...
        if (isValid === true) {
            localStorage.setItem("infor", JSON.stringify(state));
            dispatch(fetchCv(state.cccd)).unwrap().then((response) => {
                if (response === 0) {
                    router.push("/payment");
                } else {
                    alert("Dữ liệu đã có")
        ...
        <>
            ...
            <form className={clsx("row g-4", styles.form)} onSubmit={(e) => handleSubmit(e)}>
                ...
                <div className="col-md-4">
                    ...
                    <input type="text" className="form-control" name="surname" placeholder="Họ lót *" onChange={(e) => handleOnChange(e)} />
                    <span style={{ color: "red" }}>{errors.fields.surname}</span>
                </div>
                <div className="col-md-4">
                    <label htmlFor="exampleInputEmail1" className="form-label">Tên:</label>

                    <input type="text" className="form-control" name="name" placeholder="Tên *" onChange={(e) => handleOnChange(e)} />
                    <span style={{ color: "red" }}>{errors.fields.name}</span>
                </div>
                <div className="col-4">
                    <label htmlFor="exampleInputEmail1" className="form-label">Ngày sinh:</label>

                    <input type="date" className="form-control" name="birthday" id="inputAddress" onChange={(e) => handleOnChange(e)} />
                ...
                <div className="col-md-4">
                    ...
                    <select className="form-select" name="gender" defaultValue={""} onChange={(e) => handleOnChange(e)}>
                ...
                <div className="col-md-4">
                    ...
                    <input type="tel" className="form-control" id="phone" name="phone" placeholder="SĐT *" onChange={(e) => handleOnChange(e)} />
